...
<div class="col-md-3 left_col">
    <div class="left_col scroll-view">
        <div class="navbar nav_title" style="border: 0;">
            <a href="../admin/dashboard.php" class="site_title"> <span>Solimar</span></a>
        </div>
        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
                ...
                <ul class="nav side-menu">
                    ...
                    <li>
                        <a><i class="fa fa-edit"></i> AJOUTER DATA <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            <li><a href="../employee/createEmployee.php">INSERTION </a></li>
                            <li><a href="../admin/emploiHIstory.php"> History</a></li>

                         
                        </ul>
                    </li>
 <li>
                        <a><i class="fa fa-home"></i> PORFILE <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="">
                    <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                        <img src="../../resource/images/img.png" alt=""><?php echo $_SESSION['admin_name']; ?>
