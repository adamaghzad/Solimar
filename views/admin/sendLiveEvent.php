                            ...
                            <div class="x_content">
                                ...
                                <form action="../../src/store/EventStore.php" method="post" class="form-horizontal form-label-left" novalidate>
                                    ...
                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="eventSubject">Event Subject <span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="eventSubject" class="form-control col-md-7 col-xs-12" data-validate-minmax="10,20" name="eventSubject" placeholder="Event Subject" required="required" type="text">
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="eventDesc">Event Description<span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
